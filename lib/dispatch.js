...
export function cors(res, origin, host) {
  const allowed = (process.env.ALLOWED_ORIGINS || 'https://uncodeapps.icu,https://yixian-archive.vercel.app,https://imunco.github.io,http://127.0.0.1:4173,http://localhost:4173')
